...
sentence_token=[sent for sent in tokens.sents]
print(sentence_token)
sentence_score={}
for sent in sentence_token:
    for word in sent:
        if word.text.lower() in word_feq.keys():
            if sent not in sentence_score.keys():
                sentence_score[sent]=word_feq[word.text.lower()]
            else:
                 sentence_score[sent]+=word_feq[word.text.lower()]

values=sentence_score.values()
